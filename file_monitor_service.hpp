...
#ifndef FILE_MONITOR_SERVICE_HPP_INCLUDED
#define FILE_MONITOR_SERVICE_HPP_INCLUDED
...
namespace services
{
    ...
    public:
        ...
        {
            service_impl_.is_registered(impl, file);
        }
        ...
        {
            service_impl_.remove_file(impl, file, ec);
        }
...
#endif // FILE_MONITOR_SERVICE_HPP_INCLUDED
